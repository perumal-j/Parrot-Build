...
// func download_github_binary(url string) error {
// 	// Get the data
// 	resp, err := http.Get(url)
// 	if err != nil {
// 		return err
...
// 	if fileName == "" {
// 		return fmt.Errorf("failed to extract file name from URL")
// 	}

// 	// Create the file with the same name as the source
...
// func fileToBytesReader(file string) []byte {
// 	f, err := os.Open(file)
// 	if err != nil {
